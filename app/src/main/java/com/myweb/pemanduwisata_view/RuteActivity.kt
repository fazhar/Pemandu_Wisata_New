...
import com.myweb.pemanduwisata_view.databinding.ActivityRuteBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (bundle != null) {
            ...
            mainViewModel.getDetailLocation().observe(this, { modelDetail: ModelDetail ->
                ...
                //rating
                val binding: ActivityRuteBinding = ActivityRuteBinding.inflate(layoutInflater)
                setContentView(binding.root)

                val newValue = modelDetail.rating.toFloat()
                binding.ratingBar.setNumStars(5)
                binding.ratingBar.setStepSize(0.5.toDouble().toFloat())
                ...
                try {
                    ...
                    e.printStackTrace()
                    binding.tvJamOperasional.text = "Destinasi Tutup Sementara"
